...
@Component({
  selector: 'app-category-image-upload-category',
  templateUrl: './image-upload-category.component.html',
  styleUrls: ['./_image-upload-category.component.scss']
})
export class ImageUploadCategoryComponent implements OnInit {
